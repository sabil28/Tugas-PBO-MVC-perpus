            ...
            <div class="col-lg-12">
              ...
              ?>
                            <div class="d-flex align-items-center mt-3">
                                <span
                                    class="me-1 rounded-circle <?= $percentage >= 0 ? 'bg-light-success' : 'bg-light-danger'; ?> round-20 d-flex align-items-center justify-content-center">
                                    <i
                                        class="ti <?= $percentage >= 0 ? 'ti-arrow-up-left text-success' : 'ti-arrow-down-left text-danger'; ?>  "></i>
                                </span>
