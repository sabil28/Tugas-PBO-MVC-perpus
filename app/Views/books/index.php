                        ...
                        <form action="" method="get">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="search" value="<?= $search ?? ''; ?>"
                                    placeholder="Cari buku" aria-label="Cari buku" aria-describedby="searchButton">
                ...
                <tr>
                  ...
                  ?>
                                <img class="mx-auto mh-100"
                                    src="<?= base_url((!empty($book['book_cover']) && file_exists($coverImageFilePath)) ? $coverImageFilePath : BOOK_COVER_URI . DEFAULT_BOOK_COVER); ?>"
                                    alt="<?= $book['title']; ?>">
                            </div>
                        </a>
                    </td>
                    ...
                    <td><?= $book['quantity']; ?></td>
                    <td>
                        <a href="<?= base_url("admin/books/{$book['slug']}/edit"); ?>"
