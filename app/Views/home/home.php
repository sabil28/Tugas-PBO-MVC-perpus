...
<div class="px-4 pt-5 my-5 text-center border-bottom">
    ...
    <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">Temukan buku-buku menarik untuk memperluas pengetahuan dan imajinasi Anda. BukuHub adalah
            teman setia pencinta buku dan pembelajar di mana saja, kapan saja.</p>
    ...
    <div class="overflow-hidden" style="max-height: 45vh;">
        <div class="container px-5">
            <img src="<?= base_url('assets/images/dashboard.png'); ?>" class="img-fluid border rounded-3 shadow-lg mb-4"
